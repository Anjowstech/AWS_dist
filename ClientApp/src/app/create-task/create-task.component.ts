...
export class CreateTaskComponent {
  ...
  Description: any;
  Brand: any="Please enter--";
  ProductCategory: any;
  Status: any="Task created";
  Department: any="Purchase department";
  Duedate: any;
  Assigneddate: any;
  
  isproductsave = false;
  results: any;
  constructor(private http: HttpClient, public dialog: MatDialog, private router: Router, @Inject(MAT_DIALOG_DATA) public data: any) { }
  currentDate: any;
